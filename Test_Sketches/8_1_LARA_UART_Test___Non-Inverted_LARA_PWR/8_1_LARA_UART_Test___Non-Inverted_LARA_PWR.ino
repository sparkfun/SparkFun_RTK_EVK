...
void setup()
{
  ...
  digitalWrite(LARA_PWR, HIGH); // Fix for non-inverted LARA_PWR
  ...
  //digitalWrite(LARA_PWR, LOW); // Fix for non-inverted LARA_PWR
  //delay(100);
  //digitalWrite(LARA_PWR, HIGH); // Fix for non-inverted LARA_PWR
  //
  ...
  myLARA.invertPowerPin(false); // Fix for non-inverted LARA_PWR
