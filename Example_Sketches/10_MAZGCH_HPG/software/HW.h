 ...
 */
 ...
 #define HW_TARGET     SPARKFUN_RTK_EVK
#else
...
#define SPARKFUN_RTK_EVK                    51 //!< Select ESP32 / ESP32 Wrover Module
...
enum HW_PINS {  
    ...
    CAN_RX      = -1,  CAN_TX         = -1,
    I2C_SDA     = 18,  I2C_SCL        = 17,
#elif (HW_TARGET == SPARKFUN_RTK_EVK)
    LED         =  2,
    CAN_RX      = -1,  CAN_TX         = -1,
...
# endif
    ...
    // Required GPIO pin - on SPARKFUN_RTK_EVK this is the WizNet W5500 CS
